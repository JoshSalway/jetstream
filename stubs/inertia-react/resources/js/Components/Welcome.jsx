            ...
            <div className="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
                <div>
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" className="w-6 h-6 stroke-gray-400">
                    ...
                    <p className="mt-4 text-sm">
                        <a href="https://laravel.com/docs" className="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="ml-1 w-5 h-5 fill-indigo-500 dark:fill-indigo-200">
